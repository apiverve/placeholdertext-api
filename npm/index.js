...
class placeholdertextWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/placeholdertext');
        }
        ...
        this.validationRules = {"style":{"type":"string","required":false,"default":"lorem"},"paragraphs":{"type":"integer","required":false,"min":1,"max":20,"default":3},"sentences":{"type":"integer","required":false,"min":1,"max":15,"default":5}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/placeholdertext`);
        }
    }
...
module.exports = placeholdertextWrapper;
