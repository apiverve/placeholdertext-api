...
class TestPlaceholdertextAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = PlaceholdertextAPIClient(self.api_key)

    @patch('apiverve_placeholdertextgenerator.apiClient.requests.get')
