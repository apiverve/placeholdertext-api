...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/placeholdertext',
        'Source': 'https://github.com/apiverve/placeholdertext-api',
        'Bug Tracker': 'https://github.com/apiverve/placeholdertext-api/issues'
    },
    classifiers=[
