...
class PlaceholdertextAPIClient:
    ...
    VALIDATION_RULES = {
        "style": {"type": "string", "required": False, "default": "lorem"},
        "paragraphs": {"type": "integer", "required": False, "min": 1, "max": 20, "default": 3},
        "sentences": {"type": "integer", "required": False, "min": 1, "max": 15, "default": 5}
    }
