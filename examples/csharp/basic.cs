...
{
    class PlaceholderTextGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/placeholdertext";

        /// <summary>
        /// Make a GET request to the Placeholder Text Generator API
        /// </summary>
        static async Task<JsonDocument> CallPlaceholderTextGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;style&quot;] &#x3D; &quot;tech&quot;, [&quot;paragraphs&quot;] &#x3D; 3, [&quot;sentences&quot;] &#x3D; 5 };
        ...
        {
            Console.WriteLine("📤 Calling Placeholder Text Generator API...\n");

            var result = await CallPlaceholderTextGeneratorAPI();
