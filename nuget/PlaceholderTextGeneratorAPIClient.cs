...
namespace APIVerve.API.PlaceholderTextGenerator
{
    ...
    /// <summary>
    /// Client for the PlaceholderTextGenerator API
    /// </summary>
    public class PlaceholderTextGeneratorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/placeholdertext";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "paragraphs", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 20 } },
            { "sentences", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 15 } }
        };
        ...
        public PlaceholderTextGeneratorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PlaceholderTextGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PlaceholderTextGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, PlaceholderTextGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(PlaceholderTextGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(PlaceholderTextGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(PlaceholderTextGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(PlaceholderTextGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(PlaceholderTextGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(PlaceholderTextGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(PlaceholderTextGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(PlaceholderTextGeneratorQueryOptions options)
        {
