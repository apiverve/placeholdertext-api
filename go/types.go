// Package placeholdertext provides a Go client for the Placeholder Text Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/placeholdertext?utm_source=go&utm_medium=readme
package placeholdertext
...
// Request contains the parameters for the Placeholder Text Generator API.
//
// Parameters:
//   - style: string - The style of placeholder text
//   - paragraphs: integer - Number of paragraphs to generate [min: 1, max: 20]
//   - sentences: integer - Number of sentences per paragraph [min: 1, max: 15]
type Request struct {
	Style string `json:"style,omitempty"` // Optional
	Paragraphs int `json:"paragraphs,omitempty"` // Optional
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"paragraphs": {Type: "integer", Required: false, Min: float64Ptr(1), Max: float64Ptr(20)},
		"sentences": {Type: "integer", Required: false, Min: float64Ptr(1), Max: float64Ptr(15)},
	}
...
// ResponseData contains the data returned by the Placeholder Text Generator API.
type ResponseData struct {
	Style string `json:"style"`
	Paragraphs []string `json:"paragraphs"`
	ParagraphCount int `json:"paragraph_count"`
	SentencesPerParagraph int `json:"sentences_per_paragraph"`
	TotalSentences int `json:"total_sentences"`
	TotalWords int `json:"total_words"`
	TotalCharacters int `json:"total_characters"`
	FullText string `json:"full_text"`
	AvailableStyles []string `json:"available_styles"`
}
